 ...
 * @str   字符型值
 */
#define getValueIfNilReturnDefaultStr(str,default) (!str || [str isKindOfClass:[NSNull class]]) ? default : str


/* 字符串值 为空转字符串
 * @str   字符型值
 */
#define isEmpty(value) [value isEqualToString:@""] ? YES : NO
 ...
 *  @owner   所有者
 */
#define getViewByNib(Class, ownerr) [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([Class class]) owner:ownerr options:nil] lastObject]
